...
description: Explore clustering algorithms in JavaScript and TypeScript with @kanaries/ml, including K-Means, HDBSCAN, Mean Shift, OPTICS, and clustering utilities.
---
...
2. Use [HDBSCAN](hdbscan) or [OPTICS](optics) when clusters are irregular or noisy.
3. Use [Mean Shift](meanShift) when you want clustering around dense modes without committing to a cluster count up front.
