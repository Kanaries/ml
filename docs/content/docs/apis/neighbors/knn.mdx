...
description: Learn what k-Nearest Neighbors does, when to use it, and how to run KNearstNeighbors in JavaScript or TypeScript with @kanaries/ml for browser and Node.js applications.
---
...
const clf = new Neighbors.KNearstNeighbors(3, 'distance');
clf.fit(X, y);
