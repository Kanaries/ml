...
For repeated-entity datasets, use [GroupShuffleSplit or StratifiedGroupKFold](groupSplitters) so a user, patient, session, or device never appears in both train and test partitions.
